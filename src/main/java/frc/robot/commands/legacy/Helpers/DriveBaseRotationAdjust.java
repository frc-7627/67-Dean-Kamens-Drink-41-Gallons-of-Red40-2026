...
public class DriveBaseRotationAdjust extends ProgressingCommand<AutoAlignmentState> {
     ...
     * @version 2.0
     */
    public DriveBaseRotationAdjust(Indicator indicator, SwerveSubsystem module /* Bluetooth led */) {
        ...
        // Shuffleboard!
        // SmartDashboard.putNumber("Limelight/ArmAdjust/Mutiplyer",
        // OperatorConstants.IntakeNoteAmps);
    }

    /** Updates Motor Speeds and limits from shuffleboard */
    public static void updateConstants() {
        // OperatorConstants.IntakeNoteAmps =
        // SmartDashboard.getNumber("Intake/IntakeNote/Intake Note Amp Limit",
        // OperatorConstants.IntakeNoteAmps);
