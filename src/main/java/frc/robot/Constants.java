...
public final class Constants {
        ...
        public static final Predicate<Double> CHECK_SIMPLE_MOTOR_SPEED =
                        simpleMotorSpeed -> -1.0 <= simpleMotorSpeed && simpleMotorSpeed <= 1.0;
        ...
        public static final class DrivebaseConstants {
                ...
                public static final Pose2d RED_ALLIANCE_INITIAL_POSE =
        ...
        public static class LEDConstants {
                ...
                public static final int LAST_ATTACHED_LED_NUM = Math.min(
                                LAST_ONBOARD_LED_NUM + ATTACHED_LED_COUNT, FIRST_ATTACHED_LED_NUM);
                ...
                public static final SingleFadeAnimation FADE_ANIMATION = new SingleFadeAnimation(
                                FIRST_ATTACHED_LED_NUM, LAST_ATTACHED_LED_NUM);

                public static final Frequency STROBE_FREQUENCY =
                                Frequency.ofRelativeUnits(1.0, Hertz);
                public static final Frequency TWINK_FREQUENCY =
                                Frequency.ofRelativeUnits(1.0, Hertz);
                public static final Frequency FADE_FREQUENCY =
                                Frequency.ofRelativeUnits(1.0, Hertz);
        }
        ...
        public static class IndicatorConstants {
                public static class ColorArrays {
                         ...
                         */
                        public static final int[][][] DEFAULT_COLOR_ARRAYS = {/* Red alliance. */ {
                                        /* Auto */ {255, 0, 0}, /* Transition */ {255, 0, 0},
                                        /* Teleop 1 */ {255, 0, 0}, /* Teleop 2 */ {255, 0, 0},
                                        /* Teleop 3 */ {255, 0, 0}, /* Teleop 4 */{255, 0, 0},
                                        /* Endgame */ {255, 0, 0},},
                                        /* Blue alliance. */ {/* Auto */ {0, 0, 255},
                                                        /* Transition */ {0, 0, 255},
                                                        /* Teleop 1 */ {0, 0, 255},
                                                        /* Teleop 2 */ {0, 0, 255},
                                                        /* Teleop 3 */ {0, 0, 255},
        ...
        public static class GameInfoConstants {
                public static final GameInfoSupplier.Phase START_PHASE =
                                GameInfoSupplier.Phase.AUTO;
        ...
        public static class LauncherConstants {
                public static final MotionMagicVoltage TARGET_DEFAULT_POSITION =
                ...
                public static final ClosedLoopRampsConfigs DEFAULT_CLOSED_LOOP_RAMPS_CONFIGS =
                                new ClosedLoopRampsConfigs().withDutyCycleClosedLoopRampPeriod(
                                                DEFAULT_RAMP_UP_PERIOD);

                public static final AudioConfigs AUDIO_CONFIGS =
                                new AudioConfigs().withBeepOnBoot(false).withBeepOnConfig(false)
        ...
        public static class StartupConstants {
                public static final String STARTUP_BANNER_FILE_PATH = String
                                .format("%s/startup-banner.txt", Directories.DEPLOY_DIRECTORY);
        }
}
